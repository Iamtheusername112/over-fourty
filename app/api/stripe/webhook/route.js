...
export async function POST(request) {
  ...
  if (event.type === "checkout.session.completed") {
    ...
    const rawTier = (session.metadata?.tier || "FAMILY_SHIELD").toUpperCase();
    const tier = rawTier === "ACCESS" ? "ACCESS" : rawTier === "ELDER_ADVOCACY" || rawTier === "ADVOCACY" ? "ELDER_ADVOCACY" : "FAMILY_SHIELD";
